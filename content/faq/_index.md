...
draft= false
title = "Q & A"
description = " Real questions asked by real people, with real answers."
...
## Why is _solar access_ an important issue?
...
**Do you have a better idea?** I know that Eugene Public Schools and some departments in the city use tools like Facebook and Nextdoor distribute information to citizens.
...
<ol><li>There is already a process in place for evaluating the performance of the city manager.  It is unclear to Hugh that the current city council required the reporting of cost over runs, though it would have been professional to do so. Therefore it seems that the responsibility for the reporting of cost over runs (and all kinds of reporting) rests squarely with city council.
<br/><br/>
 Perhaps $7 million out of a $667 million budget is not that much. Perhaps our city budget has enough flexibility to find $7 million more dollars some other part of the budget. (Or perhaps $7 million is how much an independent elected auditor might be able to save the city tax payers, because the city manager knows where he can save $7 million.)
<br/><br/>
 This is also where open, public transactional data for budgeting and projected spending would have allowed these issues to come to light sooner — hence why we need open data from our city.</li>
<br/>
<li>There is some management philosophy precedent for limiting the time a manager has in a management position. This is practiced in the military, in some positions of government, and in some non-profit organizations like churches. One strength of this method is it allows the organization to assess the programs and policies in place independent of the people making them happen. One thing that organizations need to be aware of if they take this route is <a href="https://en.wikipedia.org/wiki/Succession_planning">succession planning</a>. Abrupt changes in management can lead to operating inefficiencies in senior leadership and confusion among staff at the operations level. Hugh has felt these impacts personally in NGOs and has observed impacts at the US Federal level.
<br/><br/>
 An independent elected auditor can help  in this situation by providing performance evaluation on the projects and programs operated by city staff.</li></ol>
...
<ol><li>
As a parent of a 2 1/2 year-old Hugh shares the concern about injury and the spread of disease via discarded needles.

>In my family I address this by taking time with my daughter to teach her about these sorts of dangers. Last week she wanted to take her shoes off and go barefoot at the playground. I said **no**. She wanted to know why so we had a discussion about dangers and hurting her feet — my main concern at the time was discarded needles, not dangers presented by park equipment.
