...
1. There is already a process in place for evaluating the performance of the city manager.  It is unclear to Hugh that the current city council required the reporting of cost over runs, though it would have been professional to do so. Therefore it seems that the responsibility for the reporting of cost over runs (and all kinds of reporting) rests squarely with city council.

 Perhaps $7 million on a budget of $667 million is not that much and can be found in other areas of the budget. (Or perhaps $7 million is how much an independent elected auditor might be able to save the city tax payers, because the city manager knows where he can save $7 million.)

 This is also where open, public transactional data for budgeting and projected spending would have allowed these issues to come to light sooner — hence why we need open data from our city.

 2. There is some management philosophy precedent for limiting the time a manager has in a management position. This is practiced in the military, in some positions of government, and in some non-profit organizations like churches. One strength of this method is it allows the organization to assess the programs and policies in place independent of the people making them happen. One thing that organizations need to be aware of if they take this route is succession planning. Abrupt changes in management can lead to operating inefficiencies in senior leadership and confusion among staff at the operations level. Hugh has seen these impacts personally in NGOs and has observed impacts at the US Federal level.
...
There are several important issues represented in this question and comment.  Hugh would like to put forward several considerations/solutions.

1. As a parent of a 2 1/2 year-old Hugh shares the concern about injury and the spread of disease via discarded needles.
>In my family I address this by taking time with my daughter to teach her about these sorts of dangers. Last week she wanted to take her shoes off and go barefoot at the playground. I said **no**, and she wanted to know why so we had a discussion about dangers and hurting her feet — my main concern at the time was discarded needles, not dangers presented by park equipment.

Our kids need parental involvement to help then identify and address dangers they will encounter — throughout life.
2. As far as Hugh is aware there is only one needle exchange in Lane County. This is at the [HIV Alliance](http://hivalliance.org/category/prevention/prev-hr/prev-hr-nex/). There may be other drop-off locations (and there are certainly other places to get needles), but part of the challenge we are presented with is that many of the needle using population don't care. This should be our biggest clue in trying to meet their needs. We should be asking _What has led them to a place where they don't care, and how can we restore hope?_
3. Neighborhood safety and cleanliness must be a grassroots effort. A regulation based effort is expensive, resource intensive, and does not address the long term needs of Eugene's homeless population. Criminalizing homelessness through the enforcement of loitering and trespassing ordinances costs the taxpayer more, and only reinforces prejudices between segments of society. We need to check our own attitudes and biases if we feel that we can regulate and solve Eugene urban camping through city ordinances. Do our solutions primarily solve _our felt needs_ (please remove the nuisance from around my dwelling) or _their felt needs_ (where and how can I live)?

Loneliness is a common theme that many people who are in a homeless situation (and also people who struggle with substance abuse) struggle with. We should ask ourselves: _How does our response (in our neighborhood, or via social services, or at city council) build community for everyone involved?_

4. Goverment in the USA, including Eugene City government, can not prevent people from doing activities. They can only react to those activities. Do you want a city ordinance which makes it legal to _conspire to_ "scatter dumpsters", or "to make noise"? Is it worth the added tax dollars to put in place a _legal response system_ to look for people who might "conspire to make noise"? No. such a system doesn't make sense. Nor does is address the needs of all of the citizens of Eugene — including the homeless, or "urban campers".
